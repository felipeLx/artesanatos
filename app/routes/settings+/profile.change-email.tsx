...
export async function action({ request }: DataFunctionArgs) {
	...
	const response = await sendEmail({
		...
		subject: `Artesanatos da Zizi Email Change Verification`,
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Artesanatos da Zizi Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
export function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your Artesanatos da Zizi email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your Artesanatos da Zizi email has been
						changed.
					</E.Text>
				</p>
				<p>
